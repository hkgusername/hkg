    ...
    <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
      {sections.map((section) => (
        ...
        >
          <a
            href={section.slug}
            className="group flex flex-col overflow-hidden rounded-2xl border border-neutral-800 bg-neutral-900 transition-all duration-300 hover:-translate-y-1 hover:border-neutral-700 hover:shadow-xl hover:shadow-black/40"
          >
            ...
            <div className="p-5">
              <h2 className="text-base font-semibold text-white group-hover:text-neutral-200">
                {section.name}
              </h2>
            </div>
          </a>
